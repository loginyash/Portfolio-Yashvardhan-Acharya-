        ...
        {() => (
            ...
            >
              <div className="w-full aspect-[4/3] overflow-hidden relative border-b border-[rgba(255,255,255,0.04)] transition-colors duration-300 flex items-center justify-center">
                {project.image ? (
                  <div className="absolute inset-0 z-10 opacity-60 group-hover:opacity-100 transition-all duration-500 filter grayscale group-hover:grayscale-0 group-hover:scale-105">
                    <img 
                      src={project.image} 
                      alt={project.title} 
              ...
              <div className="p-7 flex flex-col flex-grow relative z-30 bg-[#0F0F0F]">
                <span className="font-subheading text-[10px] uppercase tracking-widest text-[#B8B8B8] group-hover:text-white transition-colors duration-300 mb-3 block">
                  {project.tag}
                </span>
                ...
                <p className="font-inter text-[13px] leading-relaxed mb-6 text-[#B8B8B8]">
                  {project.description}
                </p>
